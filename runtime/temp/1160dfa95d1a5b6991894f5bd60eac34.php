<?php if (!defined('THINK_PATH')) exit(); /*a:45:{s:72:"E:\phpStudy\WWW\Github\admin/application/common/builder/form/layout.html";i:1507638798;s:63:"E:\phpStudy\WWW\Github\admin/application/admin/view/layout.html";i:1507638798;s:46:"./application/common/builder/aside/layout.html";i:1507638798;s:53:"./application/common/builder/aside/blocks/recent.html";i:1507638798;s:53:"./application/common/builder/aside/blocks/online.html";i:1507638798;s:53:"./application/common/builder/aside/blocks/switch.html";i:1507638798;s:49:"./application/common/builder/form/items/bmap.html";i:1507638798;s:51:"./application/common/builder/form/items/button.html";i:1507638798;s:53:"./application/common/builder/form/items/checkbox.html";i:1507638798;s:53:"./application/common/builder/form/items/ckeditor.html";i:1507638798;s:56:"./application/common/builder/form/items/colorpicker.html";i:1507638798;s:49:"./application/common/builder/form/items/date.html";i:1507638798;s:54:"./application/common/builder/form/items/daterange.html";i:1507638798;s:53:"./application/common/builder/form/items/datetime.html";i:1507638798;s:53:"./application/common/builder/form/items/editormd.html";i:1507638798;s:49:"./application/common/builder/form/items/file.html";i:1507638798;s:50:"./application/common/builder/form/items/files.html";i:1507638798;s:50:"./application/common/builder/form/items/group.html";i:1507638798;s:51:"./application/common/builder/form/items/hidden.html";i:1507638798;s:49:"./application/common/builder/form/items/icon.html";i:1507638798;s:50:"./application/common/builder/form/items/image.html";i:1507638798;s:51:"./application/common/builder/form/items/images.html";i:1507638798;s:50:"./application/common/builder/form/items/jcrop.html";i:1507638798;s:52:"./application/common/builder/form/items/linkage.html";i:1507638798;s:53:"./application/common/builder/form/items/linkages.html";i:1507638798;s:51:"./application/common/builder/form/items/masked.html";i:1507638798;s:51:"./application/common/builder/form/items/number.html";i:1507638798;s:53:"./application/common/builder/form/items/password.html";i:1507638798;s:50:"./application/common/builder/form/items/radio.html";i:1507638798;s:50:"./application/common/builder/form/items/range.html";i:1507638798;s:51:"./application/common/builder/form/items/select.html";i:1507638798;s:52:"./application/common/builder/form/items/select2.html";i:1507638798;s:49:"./application/common/builder/form/items/sort.html";i:1507638798;s:51:"./application/common/builder/form/items/static.html";i:1507638798;s:55:"./application/common/builder/form/items/summernote.html";i:1507638798;s:51:"./application/common/builder/form/items/switch.html";i:1507638798;s:49:"./application/common/builder/form/items/tags.html";i:1507638798;s:49:"./application/common/builder/form/items/text.html";i:1507638798;s:49:"./application/common/builder/form/items/time.html";i:1507638798;s:53:"./application/common/builder/form/items/textarea.html";i:1507638798;s:52:"./application/common/builder/form/items/ueditor.html";i:1507638798;s:55:"./application/common/builder/form/items/wangeditor.html";i:1507638798;s:46:"./application/common/builder/form/icon/fa.html";i:1507638798;s:46:"./application/common/builder/form/icon/gl.html";i:1507638798;s:46:"./application/common/builder/form/icon/sl.html";i:1507638798;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <script>
        ...
        var dolphin = {
            ...
            'jcrop_upload_url': '<?php echo !empty($jcrop_upload_url)?$jcrop_upload_url : url("admin/attachment/upload", ["dir" => "images", "from" => "jcrop", "module" => request()->module()]); ?>',
            'editormd_upload_url': '<?php echo !empty($editormd_upload_url)?$editormd_upload_url : url("admin/attachment/upload", ["dir" => "images", "from" => "editormd", "module" => request()->module()]); ?>',
            'editormd_mudule_path': '__LIBS__/editormd/lib/',
            'ueditor_upload_url': '<?php echo !empty($ueditor_upload_url)?$ueditor_upload_url : url("admin/attachment/upload", ["dir" => "images", "from" => "ueditor", "module" => request()->module()]); ?>',
            'wangeditor_upload_url': '<?php echo !empty($wangeditor_upload_url)?$wangeditor_upload_url : url("admin/attachment/upload", ["dir" => "images", "from" => "wangeditor", "module" => request()->module()]); ?>',
            'wangeditor_emotions': "__LIBS__/wang-editor/emotions.data",
            'ckeditor_img_upload_url': '<?php echo !empty($ckeditor_img_upload_url)?$ckeditor_img_upload_url : url("admin/attachment/upload", ["dir" => "images", "from" => "ckeditor", "module" => request()->module()]); ?>',
            'WebUploader_swf': '__LIBS__/webuploader/Uploader.swf',
            'file_upload_url': '<?php echo !empty($file_upload_url)?$file_upload_url : url("admin/attachment/upload", ["dir" => "files", "module" => request()->module()]); ?>',
            'image_upload_url': '<?php echo !empty($image_upload_url)?$image_upload_url : url("admin/attachment/upload", ["dir" => "images", "module" => request()->module()]); ?>',
            'upload_check_url': '<?php echo !empty($upload_check_url)?$upload_check_url : url("admin/ajax/check"); ?>',
            'get_level_data': '<?php echo url("admin/ajax/getLevelData"); ?>',
            'quick_edit_url': '<?php echo !empty($quick_edit_url)?$quick_edit_url : url("quickEdit"); ?>',
            'aside_edit_url': '<?php echo !empty($aside_edit_url)?$aside_edit_url : url("admin/system/quickEdit"); ?>',
            ...
            '_field_clear': <?php echo json_encode((isset($field_clear) && ($field_clear !== '')?$field_clear:[])); ?>,
...
<body>
<!-- Page Container -->
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed <?php if(empty($_pop) || (($_pop instanceof \think\Collection || $_pop instanceof \think\Paginator ) && $_pop->isEmpty())): if(!empty($_COOKIE['sidebarMini'])) echo  'sidebar-mini'; endif; ?>">
    <!-- Side Overlay-->
    ...
    <aside id="side-overlay">
        ...
        <div id="side-overlay-scroll">
            ...
            <div class="side-header side-content">
                ...
                <span>
                    <img class="img-avatar img-avatar32" src="<?php echo get_avatar(\think\Session::get('user_auth.uid')); ?>" alt="">
...
<div class="side-content remove-padding-t" id="aside">
    ...
    <div class="block pull-r-l border-t">
        ...
        <div class="block-content tab-content">
            ...
            <div class="tab-pane fade fade-right <?php if($aside['tab_nav']['curr_tab']==$key) echo 'in active'; ?>" id="<?php echo $key; ?>">
            ...
            <li>
                <div class="btn-group">
                    <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                        <img src="<?php echo get_avatar(\think\Session::get('user_auth.uid')); ?>" alt="<?php echo session('user_auth.username'); ?>">
        ...
        <div class="col-md-12">
            <div class="block">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <a href="<?php echo $tab['url']; if(!empty($_pop)) echo  '?_pop=1'; ?>"><?php echo $tab['title']; ?></a>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <li class="pull-right">
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        <div class="block-content">
                            ...
                            <form class="form-builder row" name="form-builder" action="<?php echo (isset($post_url) && ($post_url !== '')?$post_url:''); ?>" method="<?php echo $_method; ?>">
                                <?php if(empty($form_items) || (($form_items instanceof \think\Collection || $form_items instanceof \think\Paginator ) && $form_items->isEmpty())): if(!(empty($empty_tips) || (($empty_tips instanceof \think\Collection || $empty_tips instanceof \think\Paginator ) && $empty_tips->isEmpty()))): ?>
                                    <div class="form-empty">
                                        <p class="text-center text-muted empty-info">
                                            <i class="fa fa-database"></i> <?php echo $empty_tips; ?><br>
                                        </p>
                                    </div>
                                    <?php endif; else: if(is_array($form_items) || $form_items instanceof \think\Collection || $form_items instanceof \think\Paginator): $i = 0; $__LIST__ = $form_items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form): $mod = ($i % 2 );++$i;switch($form['type']): case "bmap": ?>
                                                
                                                <div class="form-group col-md-<?php echo (isset($_layout[$form['name']]) && ($_layout[$form['name']] !== '')?$_layout[$form['name']]:'12'); ?> col-xs-12 js-bmap <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" data-level="<?php echo $form['level']==''?12 : $form['level']; ?>" id="form_group_<?php echo $form['name']; ?>">
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=<?php echo (isset($form['ak']) && ($form['ak'] !== '')?$form['ak']:''); ?>"></script>
                                            <?php break; case "button": ?>
                                                ...
                                                <div class="form-group col-md-<?php echo (isset($_layout[$form['name']]) && ($_layout[$form['name']] !== '')?$_layout[$form['name']]:'12'); ?> col-xs-12" id="form_group_<?php echo $form['name']; ?>">
    <div class="col-xs-12 form-btn-parent">
        ...
        <?php endif; ?>
                                            ...
                                            <?php break; case "checkbox": ?>
                                                ...
                                                <div class="form-group col-md-<?php echo (isset($_layout[$form['name']]) && ($_layout[$form['name']] !== '')?$_layout[$form['name']]:'12'); ?> col-xs-12 <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" id="form_group_<?php echo $form['name']; ?>">
    ...
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12">
        <div class="js-colorpicker input-group" data-colorpicker-mode="<?php echo $form['mode']==''?'rgba' : $form['mode']; ?>">
    ...
    <div class="col-md-12">
        ...
        <?php endif; ?>
                                            ...
                                            <?php break; case "daterange": ?>
                                                ...
                                                <div class="form-group col-md-<?php echo (isset($_layout[$form['name_from']]) && ($_layout[$form['name_from']] !== '')?$_layout[$form['name_from']]:'12'); ?> col-xs-12 <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" id="form_group_<?php echo $form['id']; ?>">
    <label class="col-xs-12"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-md-12">
        <div class="input-daterange input-group" data-date-format="<?php echo !empty($form['format'])?$form['format'] : 'yyyy-mm-dd'; ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
            <input class="form-control" type="text" id="<?php echo $form['id_from']; ?>" name="<?php echo $form['name_from']; ?>" value="<?php echo (isset($form['value_from']) && ($form['value_from'] !== '')?$form['value_from']:''); ?>" placeholder="<?php echo $form['format']; ?>">
            <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
            <input class="form-control" type="text" id="<?php echo $form['id_to']; ?>" name="<?php echo $form['name_to']; ?>" value="<?php echo (isset($form['value_to']) && ($form['value_to'] !== '')?$form['value_to']:''); ?>" placeholder="<?php echo $form['format']; ?>">
        </div>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
            ...
            <div class="block-content tab-content block-group">
                ...
                <div class="tab-pane row <?php if($items_key == '1'): ?>active<?php endif; ?>" id="tab-<?php echo $items_key; ?>" >
                    <?php if(is_array($items) || $items instanceof \think\Collection || $items instanceof \think\Paginator): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form_group): $mod = ($i % 2 );++$i;switch($form_group['type']): case "bmap": ?>
                                ...
                                <div class="form-group col-md-<?php echo (isset($_layout[$form_group['name']]) && ($_layout[$form_group['name']] !== '')?$_layout[$form_group['name']]:'12'); ?> col-xs-12 js-bmap <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" data-level="<?php echo $form_group['level']==''?12 : $form_group['level']; ?>" id="form_group_<?php echo $form_group['name']; ?>">
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=<?php echo (isset($form_group['ak']) && ($form_group['ak'] !== '')?$form_group['ak']:''); ?>"></script>
                            <?php break; case "button": ?>
                                ...
                                <div class="form-group col-md-<?php echo (isset($_layout[$form_group['name']]) && ($_layout[$form_group['name']] !== '')?$_layout[$form_group['name']]:'12'); ?> col-xs-12" id="form_group_<?php echo $form_group['name']; ?>">
    <div class="col-xs-12 form-btn-parent">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "checkbox": ?>
                                ...
                                <div class="form-group col-md-<?php echo (isset($_layout[$form_group['name']]) && ($_layout[$form_group['name']] !== '')?$_layout[$form_group['name']]:'12'); ?> col-xs-12 <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" id="form_group_<?php echo $form_group['name']; ?>">
    ...
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-sm-12">
        <div class="js-colorpicker input-group" data-colorpicker-mode="<?php echo $form_group['mode']==''?'rgba' : $form_group['mode']; ?>">
    ...
    <div class="col-md-12">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "daterange": ?>
                                ...
                                <div class="form-group col-md-<?php echo (isset($_layout[$form_group['name_from']]) && ($_layout[$form_group['name_from']] !== '')?$_layout[$form_group['name_from']]:'12'); ?> col-xs-12 <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" id="form_group_<?php echo $form_group['id']; ?>">
    <label class="col-xs-12"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-md-12">
        <div class="input-daterange input-group" data-date-format="<?php echo !empty($form_group['format'])?$form_group['format'] : 'yyyy-mm-dd'; ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
            <input class="form-control" type="text" id="<?php echo $form_group['id_from']; ?>" name="<?php echo $form_group['name_from']; ?>" value="<?php echo (isset($form_group['value_from']) && ($form_group['value_from'] !== '')?$form_group['value_from']:''); ?>" placeholder="<?php echo $form_group['format']; ?>">
            <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
            <input class="form-control" type="text" id="<?php echo $form_group['id_to']; ?>" name="<?php echo $form_group['name_to']; ?>" value="<?php echo (isset($form_group['value_to']) && ($form_group['value_to'] !== '')?$form_group['value_to']:''); ?>" placeholder="<?php echo $form_group['format']; ?>">
        </div>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    ...
    <div class="col-xs-12 js-upload-images">
        ...
        <?php endif; ?>
                            ...
                            <?php break; case "jcrop": ?>
                                ...
                                <div class="form-group col-md-<?php echo (isset($_layout[$form_group['name']]) && ($_layout[$form_group['name']] !== '')?$_layout[$form_group['name']]:'12'); ?> col-xs-12 js-jcrop-interface <?php echo (isset($form_group['extra_class']) && ($form_group['extra_class'] !== '')?$form_group['extra_class']:''); ?>" id="form_group_<?php echo $form_group['name']; ?>">
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-sm-12">
...
<div class="form-group col-md-<?php echo (isset($_layout[$form_group['name']]) && ($_layout[$form_group['name']] !== '')?$_layout[$form_group['name']]:'12'); ?> col-xs-12" id="form_group_<?php echo $form_group['name']; ?>">
    ...
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-sm-12">
        <input class="form-control" type="password" id="<?php echo $form_group['name']; ?>" name="<?php echo $form_group['name']; ?>" value="<?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?>" placeholder="<?php echo (isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请输入'.$form_group['title']); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-sm-12">
        <select class="js-select2 form-control" id="<?php echo $form_group['name']; ?>" name="<?php echo $form_group['name']; ?>" data-allow-clear="true" data-placeholder="<?php echo (isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请选择一项'); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
            <option></option>
            <?php if(is_array($form_group['options']) || $form_group['options'] instanceof \think\Collection || $form_group['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form_group['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
            <option value="<?php echo $key; ?>" <?php if(($form_group['value'] == (string)$key|| $form_group['value'] == (string)$option)): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
    ...
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-sm-12">
        <select class="js-select2 form-control" id="<?php echo $form_group['name']; ?>" name="<?php echo $form_group['name']; ?>[]" data-allow-clear="true" data-placeholder="<?php echo (isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请选择一项或多项'); ?>" multiple="multiple" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
    ...
    <div class="col-sm-12">
        ...
        <input type="hidden" name="<?php echo $form_group['name']; ?>" value='<?php echo (isset($form_group['hidden']) && ($form_group['hidden'] !== '')?$form_group['hidden']:""); ?>'>
        <?php endif; if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-sm-12">
        ...
        <input class="form-control" type="text" id="<?php echo $form_group['name']; ?>" name="<?php echo $form_group['name']; ?>" value="<?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?>" placeholder="<?php echo (isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请输入'.$form_group['title']); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>>
    ...
    <label class="col-xs-12" for="<?php echo $form_group['name']; ?>"><?php echo htmlspecialchars($form_group['title']); ?></label>
    <div class="col-xs-12">
        <textarea class="form-control" id="<?php echo $form_group['name']; ?>" rows="7" name="<?php echo $form_group['name']; ?>" placeholder="<?php echo (isset($form_group['placeholder']) && ($form_group['placeholder'] !== '')?$form_group['placeholder']:'请输入'.$form_group['title']); ?>" <?php echo (isset($form_group['extra_attr']) && ($form_group['extra_attr'] !== '')?$form_group['extra_attr']:''); ?>><?php echo (isset($form_group['value']) && ($form_group['value'] !== '')?$form_group['value']:''); ?></textarea>
        <?php if(!(empty($form_group['tips']) || (($form_group['tips'] instanceof \think\Collection || $form_group['tips'] instanceof \think\Paginator ) && $form_group['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form_group['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-xs-12">
        ...
        <?php endif; ?>
                            ...
                            <?php break; default: ?>
                            <?php echo extend_form_item($form_group, $_layout); endswitch; endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
    ...
    <div class="col-xs-12 js-upload-images">
        ...
        <?php endif; ?>
                                            ...
                                            <?php break; case "jcrop": ?>
                                                ...
                                                <div class="form-group col-md-<?php echo (isset($_layout[$form['name']]) && ($_layout[$form['name']] !== '')?$_layout[$form['name']]:'12'); ?> col-xs-12 js-jcrop-interface <?php echo (isset($form['extra_class']) && ($form['extra_class'] !== '')?$form['extra_class']:''); ?>" id="form_group_<?php echo $form['name']; ?>">
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12">
...
<div class="form-group col-md-<?php echo (isset($_layout[$form['name']]) && ($_layout[$form['name']] !== '')?$_layout[$form['name']]:'12'); ?> col-xs-12" id="form_group_<?php echo $form['name']; ?>">
    ...
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12">
        <input class="form-control" type="number" id="<?php echo $form['name']; ?>" name="<?php echo $form['name']; ?>" value="<?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?>" placeholder="<?php echo (isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请输入'.$form['title']); ?>" <?php if(isset($form['min']) && $form['min'] !== ''): ?>min="<?php echo $form['min']; ?>"<?php endif; if(isset($form['max']) && $form['max'] !== ''): ?>max="<?php echo $form['max']; ?>"<?php endif; if(isset($form['step']) && $form['step'] !== ''): ?>step="<?php echo $form['step']; ?>"<?php endif; ?> <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12">
        <input class="form-control" type="password" id="<?php echo $form['name']; ?>" name="<?php echo $form['name']; ?>" value="<?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?>" placeholder="<?php echo (isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请输入'.$form['title']); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12">
        <select class="js-select2 form-control" id="<?php echo $form['name']; ?>" name="<?php echo $form['name']; ?>" data-allow-clear="true" data-placeholder="<?php echo (isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请选择一项'); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
            <option></option>
            <?php if(is_array($form['options']) || $form['options'] instanceof \think\Collection || $form['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$option): $mod = ($i % 2 );++$i;?>
            <option value="<?php echo $key; ?>" <?php if(($form['value'] == (string)$key|| $form['value'] == (string)$option)): ?>selected<?php endif; ?>><?php echo clear_js($option); ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
    ...
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-sm-12">
        <select class="js-select2 form-control" id="<?php echo $form['name']; ?>" name="<?php echo $form['name']; ?>[]" data-allow-clear="true" data-placeholder="<?php echo (isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请选择一项或多项'); ?>" multiple="multiple" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
    ...
    <div class="col-sm-12">
        ...
        <input type="hidden" name="<?php echo $form['name']; ?>" value='<?php echo (isset($form['hidden']) && ($form['hidden'] !== '')?$form['hidden']:""); ?>'>
        <?php endif; if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-sm-12">
        ...
        <input class="form-control" type="text" id="<?php echo $form['name']; ?>" name="<?php echo $form['name']; ?>" value="<?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?>" placeholder="<?php echo (isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请输入'.$form['title']); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>>
    ...
    <label class="col-xs-12" for="<?php echo $form['name']; ?>"><?php echo htmlspecialchars($form['title']); ?></label>
    <div class="col-xs-12">
        <textarea class="form-control" id="<?php echo $form['name']; ?>" rows="7" name="<?php echo $form['name']; ?>" placeholder="<?php echo (isset($form['placeholder']) && ($form['placeholder'] !== '')?$form['placeholder']:'请输入'.$form['title']); ?>" <?php echo (isset($form['extra_attr']) && ($form['extra_attr'] !== '')?$form['extra_attr']:''); ?>><?php echo (isset($form['value']) && ($form['value'] !== '')?$form['value']:''); ?></textarea>
        <?php if(!(empty($form['tips']) || (($form['tips'] instanceof \think\Collection || $form['tips'] instanceof \think\Paginator ) && $form['tips']->isEmpty()))): ?>
        <div class="help-block"><?php echo clear_js($form['tips']); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div class="col-xs-12">
        ...
        <?php endif; ?>
                                            ...
                                            <?php break; default: ?>
                                            <?php echo extend_form_item($form, $_layout); endswitch; endforeach; endif; else: echo "" ;endif; endif; ?>
