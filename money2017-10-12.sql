...
-- ----------------------------
INSERT INTO `dp_admin_user` VALUES ('1', 'admin', '超级管理员', '$2y$10$Brw6wmuSLIIx3Yabid8/Wu5l8VQ9M/H/CG3C9RqN9dUCwZW3ljGOK', '', '0', '', '0', '0', '0.00', '0', '1', '0', '0', '1476065410', '1507427063', '1507427063', '2130706433', '100', '1');
...
CREATE TABLE `dp_balance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='余额种类表';

-- ----------------------------
-- Records of dp_balance
-- ----------------------------
INSERT INTO `dp_balance` VALUES ('1', '微信', '240.13');
INSERT INTO `dp_balance` VALUES ('2', '支付宝', '1038.74');
...
CREATE TABLE `dp_money_details` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='金币详情表';
...
INSERT INTO `dp_money_details` VALUES ('50', '-7', '晚餐 凉皮', '7', '0', '1', '1507811450');
...
INSERT INTO `dp_type` VALUES ('109', '银证转账', '100', '102');
