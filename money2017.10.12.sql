...
-- ----------------------------
INSERT INTO `dp_balance` VALUES ('1', '微信', '247.13');
...
CREATE TABLE `dp_money_details` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='金币详情表';
...
INSERT INTO `dp_money_details` VALUES ('46', '-3.5', '早餐 稀饭鸡蛋', '2', '1', '2', '1507772274');
INSERT INTO `dp_money_details` VALUES ('47', '-10', '午餐 快餐', '3', '1', '2', '1507787963');
INSERT INTO `dp_money_details` VALUES ('48', '-53', '礼物 补偿女神生日的下午茶', '106', '12', '1', '1507788016');
...
CREATE TABLE `dp_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='交易类型表';
