...
-- ----------------------------
INSERT INTO `dp_admin_user` VALUES ('1', 'admin', '超级管理员', '$2y$10$Brw6wmuSLIIx3Yabid8/Wu5l8VQ9M/H/CG3C9RqN9dUCwZW3ljGOK', '', '0', '', '0', '0', '0.00', '0', '1', '0', '0', '1476065410', '1507867538', '1507867538', '2130706433', '100', '1');
...
-- ----------------------------
INSERT INTO `dp_balance` VALUES ('1', '微信', '240.13');
INSERT INTO `dp_balance` VALUES ('2', '支付宝', '1023.24');
...
CREATE TABLE `dp_money_details` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='金币详情表';

-- ----------------------------
-- Records of dp_money_details
-- ----------------------------
INSERT INTO `dp_money_details` VALUES ('1', '-14', '午餐 兰州拉面', '3', '1', '1', '1507379674');
INSERT INTO `dp_money_details` VALUES ('2', '-131.8', '电影票 3张', '103', '5', '1', '1507464327');
INSERT INTO `dp_money_details` VALUES ('3', '-10', '晚餐 腌面', '7', '1', '1', '1507464378');
...
INSERT INTO `dp_money_details` VALUES ('7', '-48', '送父亲大人 车载手机支架', '105', '12', '2', '1507556196');
INSERT INTO `dp_money_details` VALUES ('8', '-887', '房租 + 水电费', '9', '6', '2', '1507556214');
INSERT INTO `dp_money_details` VALUES ('9', '-11', '晚餐 排骨面', '7', '1', '1', '1507556231');
INSERT INTO `dp_money_details` VALUES ('10', '-3.5', '早餐 稀饭鸡蛋', '2', '1', '2', '1507600251');
INSERT INTO `dp_money_details` VALUES ('12', '-12', '午餐 快餐', '3', '1', '2', '1507616304');
INSERT INTO `dp_money_details` VALUES ('13', '-10', '晚餐 燃面', '7', '1', '1', '1507639020');
INSERT INTO `dp_money_details` VALUES ('14', '-7.5', '水果 香蕉', '107', '4', '1', '1507639090');
INSERT INTO `dp_money_details` VALUES ('15', '-3.5', '早餐 稀饭鸡蛋', '2', '1', '2', '1507687622');
INSERT INTO `dp_money_details` VALUES ('24', '-10', '午餐 快餐', '3', '1', '2', '1507705936');
INSERT INTO `dp_money_details` VALUES ('41', '-20', '礼物 女神生日送腾讯会员一个月', '106', '12', '1', '1507716154');
INSERT INTO `dp_money_details` VALUES ('42', '1000', '[收款]支付宝收到中国银行的转账,收款金额100元,手续费0元', '108', '100', '2', '1507716512');
INSERT INTO `dp_money_details` VALUES ('43', '-1000', '[转账]中国银行向支付宝发起转账,转账金额100元,手续费0元', '108', '100', '5', '1507716512');
INSERT INTO `dp_money_details` VALUES ('44', '-6', '小吃 肉夹馍', '102', '4', '1', '1507722318');
INSERT INTO `dp_money_details` VALUES ('45', '-7', '晚餐 青菜面', '7', '1', '1', '1507723146');
INSERT INTO `dp_money_details` VALUES ('46', '-20', '桶装水', '110', '6', '6', '1507726119');
INSERT INTO `dp_money_details` VALUES ('47', '-3.5', '早餐 稀饭鸡蛋', '2', '1', '2', '1507772274');
INSERT INTO `dp_money_details` VALUES ('48', '-10', '午餐 快餐', '3', '1', '2', '1507787963');
INSERT INTO `dp_money_details` VALUES ('49', '-53', '礼物 补偿女神生日的下午茶', '106', '12', '1', '1507788016');
INSERT INTO `dp_money_details` VALUES ('50', '-7', '晚餐 凉皮', '7', '1', '1', '1507811450');
INSERT INTO `dp_money_details` VALUES ('51', '-2.62', '早餐 稀饭鸡蛋', '2', '1', '2', '1507858124');
INSERT INTO `dp_money_details` VALUES ('52', '1000', '[收款]平安证券收到中国银行的转账,收款金额为:1000元,手续费为:0元', '109', '100', '7', '1507864439');
INSERT INTO `dp_money_details` VALUES ('53', '-1000', '[转账]中国银行向平安证券发起转账,转账金额为:-1000元,手续费为:0元', '109', '100', '5', '1507864439');
INSERT INTO `dp_money_details` VALUES ('54', '-12', '午餐 快餐', '3', '1', '2', '1507875275');
...
CREATE TABLE `dp_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COMMENT='交易类型表';
