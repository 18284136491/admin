...
INSERT INTO `dp_balance` VALUES ('2', '支付宝', '909.37');
...
CREATE TABLE `dp_money_details` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='金币详情表';
...
INSERT INTO `dp_type` VALUES ('120', '抢红包', '0', '1');
